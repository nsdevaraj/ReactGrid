...
import { DropdownNumberCell } from '../cellTemplates/dropdownNumberCell/DropdownNumberCellTemplate';
...
export const rows = (reorderable: boolean, height: number = 25): Row<DefaultCellTypes | FlagCell | DropdownNumberCell>[] => [
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'usa' },
      { type: 'date', date: new Date('2062-09-04') },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'chn' },
      { type: 'date', date: new Date('2085-11-06') },
      { type: 'text', text: 'CEO' },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'rus' },
      { type: 'date', date: new Date('2085-12-28') },
      { type: 'text', text: 'QA' },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'usa' },
      { type: 'date', date: new Date('2073-07-11') },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'usa' },
      { type: 'date', date: new Date('2043-09-25') },
      { type: 'text', text: 'CFO' },
      { type: 'dropdownNumber', value: 100, isOpened: false },
      { type: 'checkbox', checked: false }
    ]
  },
  {
    ...
    cells: [
      ...
      { type: 'date', date: new Date('2017-07-13') },
      { type: 'flag', text: 'mex' },
      { type: 'date', date: new Date('2024-09-15') },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'gtm' },
      { type: 'date', date: new Date('2024-12-01') },
      { type: 'text', text: 'CFO' },
      { type: 'dropdownNumber', value: 100, isOpened: false },
      { type: 'checkbox', checked: true }
    ]
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'cub' },
      { type: 'date', date: new Date('2029-07-12') },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'arg' },
      { type: 'date', date: new Date('2024-02-07') },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'aus' },
      { type: 'date', date: new Date('2024-01-04') },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'gbr' },
      { type: 'date', date: new Date('2020-04-18') },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'FRA' },
      { type: 'date', date: new Date('2020-04-15') },
      { type: 'text', text: 'CPA' },
      { type: 'dropdownNumber', value: 20, isOpened: false },
      { type: 'checkbox', checked: false }
    ]
  },
  {
    ...
    cells: [
      ...
      { type: 'flag', text: 'can' },
      { type: 'date', date: new Date('2020-01-24') },
      { type: 'text', text: '--' },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'date', date: new Date('2018-06-19') },
      { type: 'flag', text: 'ita' },
      { type: 'date', date: new Date('2027-02-24') },
      { type: 'text', text: 'COO' },
      { type: 'dropdownNumber', value: 50, isOpened: false },
      { type: 'checkbox', checked: false }
    ]
  },
  {
    ...
    cells: [
      ...
      { type: 'date', date: new Date('2018-06-19') },
      { type: 'flag', text: 'egy' },
      { type: 'date', date: new Date('2025-08-27') },
      { type: 'text', text: '--' },
      { type: 'dropdownNumber', value: 20, isOpened: false },
      { type: 'checkbox', checked: false }
    ]
  },
  {
    ...
    cells: [
      ...
      { type: 'date', date: new Date('2018-06-19') },
      { type: 'flag', text: 'grc' },
      { type: 'date', date: new Date('2028-05-11') },
  ...
  },
  {
    ...
    cells: [
      ...
      { type: 'date', date: new Date('2018-06-19') },
      { type: 'flag', text: 'swe' },
      { type: 'date', date: new Date('2028-04-02') },
